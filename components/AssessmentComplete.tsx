...
<body>
  ...
  <body>
      ...
      <div class="footer">
        ...
        // Trigger print from the parent window after content renders.
        // The load event listener inside document.write() doesn't fire reliably
        // because the document is already considered loaded by the time it attaches.
        setTimeout(() => {
          try {
            printWindow.print();
          } catch {
            // If print fails (e.g. cross-origin), the manual button is still available
          }
        }, 600);
